  ...
  if (step === 'verify') {
    return (
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <LinearGradient colors={['#1a4d7a', '#2980b9']} style={styles.gradient}>
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <LinearGradient colors={['#1a4d7a', '#2980b9']} style={styles.gradient}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <Image source={require('../assets/images/icon.png')} style={styles.logo} resizeMode="contain" />
          <Text style={styles.title}>SmartEdu Students</Text>
          <Text style={styles.subtitle}>O'quvchilar uchun panel</Text>
          <View style={styles.formContainer}>
          ...
          <Text style={styles.versionText}>SmartEdu v1.0 • Students</Text>
        </ScrollView>
      </LinearGradient>
    </KeyboardAvoidingView>
  );
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: '#ccf', textAlign: 'center', marginBottom: 32, opacity: 0.85 },
  ...
  loginButton: { backgroundColor: '#1a4d7a', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
  ...
  backLinkText: { color: '#1a4d7a', fontSize: 14 },
