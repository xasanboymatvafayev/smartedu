  ...
  if (step === 'verify') {
    return (
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <LinearGradient colors={['#1a6b3c', '#2ecc71']} style={styles.gradient}>
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <LinearGradient colors={['#1a6b3c', '#2ecc71']} style={styles.gradient}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <Image source={require('../assets/images/icon.png')} style={styles.logo} resizeMode="contain" />
          <Text style={styles.title}>SmartEdu Teachers</Text>
          <Text style={styles.subtitle}>Ustozlar uchun panel</Text>
          <View style={styles.formContainer}>
          ...
          <Text style={styles.versionText}>SmartEdu v1.0 • Teachers</Text>
        </ScrollView>
      </LinearGradient>
    </KeyboardAvoidingView>
  );
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: '#cfc', textAlign: 'center', marginBottom: 32, opacity: 0.85 },
  ...
  loginButton: { backgroundColor: '#1a6b3c', borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 8 },
